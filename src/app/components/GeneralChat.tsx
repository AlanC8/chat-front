    ...
    <div>
      {loading ? (
        <div className="h-[750px]">
          {" "}
          <h1 className="text-center text-5xl text-white my-[300px]">
            Загрузка сообщении...
          </h1>
        </div>
      ) : (
        <div className="flex flex-col h-[750px] bg-white rounded-md">
          <div className="bg-white text-black px-6 py-4 rounded-t-md">
            <h1 className="text-center text-2xl">Общий чат</h1>
            <p className="text-center opacity-[60%]"> {numberOfUsers} online</p>
          </div>
          <hr />
          <div
            className="flex-grow py-6 px-10 overflow-y-auto"
          ...
          >
            {messages.map((message, index) => {
              if (message.username === username) {
                ...
                return (
                  <div key={index} className="flex-grow py-6 overflow-y-auto">
                    <div className="flex flex-col space-y-4">
